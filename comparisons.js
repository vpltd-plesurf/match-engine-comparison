...
window.COMPARISONS_DATA = [
  {
    ...
    "assessmentHistory": [
      ...
      },
      {
        ...
        "gameFeature": 79,
        "fullGame": 85,
        "note": "Balance regression: 17-32 scorelines diagnosed. 6 compounding issues identified."
      },
      {
        "date": "2026-02-16",
        "matchEngine": 96,
        "gameFeature": 81,
        "fullGame": 89,
        "note": "ALL scoring realism fixes applied. Pack purchase overhaul. 8 commits, 26 files."
      },
      {
        "date": "2026-02-17",
        "matchEngine": 97,
        "gameFeature": 81,
        "fullGame": 89,
        "note": "Massive realism pass: 25 files, 1007 insertions. Pass overhaul, GK AI, sprint decisions, corner defense, smart subs. Decision interval halved (worsens scoring). cmp-053 7-area plan critical."
      },
      {
        "date": "2026-02-17-deepdive",
        "matchEngine": 98,
        "gameFeature": 81,
        "fullGame": 89,
      ...
      },
      {
        ...
        "gameFeature": 82,
        "fullGame": 89,
        "note": "Status audit (no new commits since 17 Feb). 8 entries corrected: cmp-028 chemistry confirmed active (15% bonus), cmp-043/cmp-047 confirmed resolved, cmp-046 transition cache confirmed (0.9s + 0.3s throttle). cmp-030/gf-014/gf-021/gf-024 reclassified resolved-with-advisory. BUG-010/011 still open."
      },
      {
        "date": "2026-02-23",
        "matchEngine": 98,
  ...
  },
  {
    ...
    "priority": "P2",
    "status": "resolved with advisory",
    "fm2026Details": "NEW dedicated aiDribble.js (460 lines, 5 dribble types). computeDribbleIntent() evaluates all 5 types and picks best score. (1) computeCarryIntent(): advance toward goal with boundary avoidance, 6-yard box hard limit. (2) computeCutIntent(): intelligence-based cut-inside for wide players (fieldWidth*0.35 trigger), GK jink evasion (1.15x boost within 15m of goal). (3) computeGapDribbleIntent(): find lanes between 4 nearest defenders, gap width >4m required, knock-on mechanic (pace>75, push ball 5m ahead). (4) computeShieldIntent(): hold position under pressure. (5) computeRetreatIntent(): back away from blocked paths, intelligence-based. computeDribbleScore(): 7-factor scoring (progress 0.4-2.5x, safety/opponent proximity, skill retention, solo run penalty 40m limit, boundary avoidance 1.5m buffer, role/zone bias per-position map, game state awareness chasing 1.2x/protecting 0.7x, heat map space). 30+ DRIBBLE constants in aiConstants.js. DRIBBLE.ROLE_BIAS map for all positions (GK 0.0, CB 0.1, FB 0.6, CM 0.5, AM 0.9, W 1.2, ST 0.8).",
    "fm2026Files": [
      "ai/aiDribble.js:1-460 (full dedicated dribble AI module)",
      "aiConstants.js:DRIBBLE section (30+ constants)",
      "playerAIController.js (calls computeDribbleIntent)"
    ],
  ...
  },
  {
    ...
    "fm2026Details": "[FIXED 16 Feb] Foul base chance reverted from debug 0.35 to production 0.05 in challengeController.js. 6 foul types in FOUL_TYPES. determineFoulType() uses context (tackle type, location, intent). Base rate now produces realistic fouls before aggression/tackling modifiers.",
    "fm2026Files": [
  ...
  },
  {
    ...
    "gapAnalysis": "Improved from previous assessment: linesman error added, stale flag clearing fixed, offside enforcement on possession. Remaining gaps: (1) 5-second window still longer than ideal (Legacy is immediate), (2) no assistant referee trigger logic, (3) dynamic offside trap is present but basic (step-up only, no coordinated team-wide trap call). Priority: P2.",
  ...
  },
  {
    ...
    "priority": "P1",
    "status": "resolved with advisory",
    "fm2026Details": "FK taker selection: quality score = 40% curve + 30% training + 30% specialist flag + proximity bonus. GK penalized -50. Short FK option: 20% base chance (higher if >35m from goal), helper positions 3.5m from ball. Wall logic: players face ball and hold position. Ceremony enforcement: card ceremony delays (red 15s, yellow 3s) via restart.minWaitUntil. Double-touch rule: ball.requiresOtherPlayerTouch set on execution. Training attribute impact on FK quality. Injured player check for taker.",
    "fm2026Files": [
  ...
  },
  {
    ...
    "priority": "P2",
    "status": "resolved with advisory",
    "fm2026Details": "Throw-in: 3-option positioning (short 4m, medium 8m, down-the-line 12m) ranked by proximity. Goal kick: 1.15x expansion scaling for formation spread. GK distribution: throw cap 25m; kick power scales 18.0-35.0 for distances 25-50m. Set-piece tactical scaling: kickoff 0.85x compression, goal kick 1.15x expansion. Stall detection: 1200 tick warning in DEAD_BALL state. Smooth player reset (walk to position, 8s timeout).",
    "fm2026Files": [
  ...
  },
  {
    ...
    "gapAnalysis": "Significant progress from 35% to 55%. FM2026 now has: linesman error, referee blind spot, card-based injury time, second yellow logic, GK protection, 6 foul types. Still MISSING: advantage play detection, VAR simulation, visual referee entity with positioning, assistant referee flag timing, offside assistant trigger logic. These are low priority for headless server simulation.",
    "codeSuggestions": "Remaining: advantage play (allow play to continue if fouled team maintains possession/position), visual referee entity (low priority). VAR is optional polish."
  },
  {
    "id": "cmp-038-ai-audit",
    "date": "2026-02-10T19:11:39Z",
  ...
  },
  {
    ...
    "fm2026Files": [
      ...
      "challengeController.js:386-394 (determineCard)",
      "challengeController.js:440-459 (foul resolution with lastMan check)"
    ],
  ...
  },
  {
    ...
    "date": "2026-02-17T14:00:00Z",
    "category": "matchEngine",
    "feature": "Realistic Match Balance for Full 90-Minute Simulation",
    "existsInFM2026": "yes",
    "existsInLegacy": "yes",
    "priority": "P2",
    "status": "resolved with advisory",
    ...
    "legacyFiles": [
      "GameManager.cs:24-26 (HALF_LENGTH=300, TIMESCALE=750)",
  ...
  },
  {
    ...
    "status": "open",
    "exceedsLegacy": false,
    "fm2026Details": "6 packs in packs.json. Each pack yields ONLY its own rarity level — no mixed drops.\n\nPack contents (NFTs minted per pack, includes kits and badges):\n  Regular:   0.01 SOL — 1P + 1T + 3B + 1Kit + 1Badge = 7 NFTs\n  Rare:      0.05 SOL — 2P + 2T + 2B + 2Kit + 1Badge = 9 NFTs\n  Epic:      0.10 SOL — 3P + 3T + 3B + 2Kit + 2Badge = 13 NFTs\n  Legendary: 0.25 SOL — 3P + 3T + 3B + 2Kit + 2Badge = 13 NFTs\n  Pack 4:    Free test (~100 mixed cards, all rarities)\n  Pack 1000: Free hidden rare starter (13 Rare cards)\n\nMINTING COST BREAKDOWN (verified from code):\n  Bot tax: 0.001 SOL per candy machine mint (nftService.js:320, hardcoded)\n  Per-NFT rent: ~0.00203 SOL (Metaplex mpl-token-metadata v3.4.0 default — NOT explicit in FM2026 code, but standard for account size)\n  NFT type: Standard Metaplex NonFungible (nftService.js:303,353) — NOT compressed NFTs (no Bubblegum/Merkle references found)\n  Minting signer: SERVER wallet (nftService.js:105-112, createNft uses this.signer) — the platform pays rent, not the user\n  User pays: pack price via solPayment guard (nftService.js:402-405) → goes to owner wallet\n\nPLATFORM COST PER PACK (server-side rent):\n  Regular:   7 × 0.00203 = 0.0142 SOL rent vs 0.01 SOL revenue = -0.0042 SOL LOSS\n  Rare:      9 × 0.00203 = 0.0183 SOL rent vs 0.05 SOL revenue = +0.0317 SOL profit\n  Epic:     13 × 0.00203 = 0.0264 SOL rent vs 0.10 SOL revenue = +0.0736 SOL profit\n  Legendary:13 × 0.00203 = 0.0264 SOL rent vs 0.25 SOL revenue = +0.2236 SOL profit\n  Free:     Cards for Free rarity skip NFT minting entirely (cardsService.js: if rarity != Rarity.Free)\n\nNote: Currently on Devnet (nftService.js:49, Helius RPC). SOL is free on devnet, so losses are theoretical. On mainnet these costs are real.",
    "fm2026Files": [
      "data/packs.json (pack definitions, prices, content arrays — 7/9/13/13 NFTs per pack)",
      "api/services/nftService.js:320 (bot tax: sol(0.001))",
      "api/services/nftService.js:105-112 (createNft — server wallet pays rent via this.signer)",
      "api/services/nftService.js:303,353 (TokenStandard.NonFungible — standard NFTs, not compressed)",
      "api/services/nftService.js:402-405 (solPayment guard — user pays pack price to owner)",
      "api/services/nftService.js:49 (Devnet RPC: helius-rpc.com)",
      "api/services/cardsService.js:143-207 (openCardsPack — iterates content array, mints each card)",
      "package.json (@metaplex-foundation/mpl-token-metadata ^3.4.0, mpl-candy-machine ^6.1.0)"
    ],
    ...
    "legacyFiles": [],
    "gapAnalysis": "PDF proposes 4 tiers: Starter ($2.50, 5 cards), Standard ($7.50, 9 cards), Premium ($25, 16 cards), Ultra ($100, 5 guaranteed high-rarity).\n\nCurrent FM2026 pricing problems:\n1. Regular packs are sold at a LOSS (-0.0042 SOL per pack in server rent costs)\n2. Legendary packs are too cheap — 3 packs (~0.75 SOL) gives 9 Legendary players (near full XI)\n3. Platform pays all minting rent from server wallet, user only pays pack price\n4. Standard Metaplex NFTs used (~0.00203 SOL rent each) — compressed NFTs (cNFTs) would cost ~0.00000008 SOL each (25,000× cheaper) but are not implemented\n5. Single-rarity packs remove the excitement of probabilistic drops\n\nOn mainnet at SOL ~$140: Regular pack ($1.40) costs ~$2.00 to mint. Platform subsidises every Regular pack buyer.",
    "codeSuggestions": "RECOMMENDED — THREE OPTIONS (combine as needed):\n\nOption A — RAISE PRICES to cover minting costs:\n  Starter:  0.05 SOL (7 cards) — covers 0.0142 rent + margin\n  Standard: 0.15 SOL (9 cards) — covers 0.0183 rent + margin\n  Premium:  0.40 SOL (13 cards) — covers 0.0264 rent + margin\n  Ultra:    1.00 SOL (13 cards, high rarity) — premium tier\n\nOption B — LAZY-MINT (RECOMMENDED for free/low-tier packs):\n  Generate cards as regular DB records (not NFTs) by default.\n  Only mint as NFTs when a player explicitly chooses 'Export to Chain'.\n  This eliminates minting costs for cards that may never be traded.\n  Export-to-chain fee: 0.01 SOL (covers rent) paid by the USER.\n  Free packs already skip minting (rarity == Free check) — extend this to Regular packs.\n\nOption C — SWITCH TO COMPRESSED NFTs (cNFTs):\n  Use @metaplex-foundation/bubblegum instead of mpl-token-metadata.\n  Cost per cNFT: ~0.00000008 SOL (vs 0.00203 for standard) — 25,000× cheaper.\n  Regular pack: 7 × 0.00000008 = 0.0000006 SOL — effectively free.\n  Trade-off: cNFTs are stored in Merkle trees, slightly different transfer UX.\n  Requires: new dependency, Merkle tree setup (~1.5 SOL one-time for 2^20 tree).\n\nBest approach: Option B for Starter/Standard packs + Option A for Premium/Ultra + Option C as future migration path."
  },
  {
